    ...
    <div className="w-full relative overflow-hidden bg-gradient-to-br from-primary-deep via-primary-dark to-primary text-white">
      <Container id="kontak" className="bg-transparent">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <a
                ...
                className="flex items-center gap-3.5 p-3.5 rounded-xl bg-white/[0.07] border border-white/12 hover:bg-white/[0.14] hover:border-white/25 transition-colors group"
              >
                <div className="w-10 h-10 rounded-lg bg-emerald-500/20 text-emerald-400 flex items-center justify-center shrink-0">
                  <MessageCircle className="w-5 h-5" />
                </div>
                <div className="min-w-0 flex-1">
                  <div className="text-[0.72rem] text-white/60 font-medium">WhatsApp Resmi</div>
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <div className="text-[0.72rem] text-white/60 font-medium">Telepon Kantor</div>
                  <div className="text-white text-[0.88rem] font-semibold truncate group-hover:text-accent-light transition-colors">
              ...
              <div className="flex items-center gap-3.5 p-3.5 rounded-xl bg-white/[0.07] border border-white/12">
                <div className="w-10 h-10 rounded-lg bg-white/15 text-white/90 flex items-center justify-center shrink-0">
                  <Mail className="w-5 h-5" />
                </div>
                <div className="min-w-0 flex-1">
                  <div className="text-[0.72rem] text-white/60 font-medium">Email Pemesanan</div>
                  <div className="text-white/95 text-[0.88rem] font-semibold truncate">
              ...
              <div className="flex items-center gap-3.5 p-3.5 rounded-xl bg-white/[0.07] border border-white/12">
                ...
                <div className="min-w-0 flex-1">
                  <div className="text-[0.72rem] text-white/60 font-medium">Jam Layanan CS</div>
                  <div className="text-white/95 text-[0.85rem] font-semibold truncate">
                    {company.contact.operatingHours}
                  </div>
                </div>
              </div>

              <div className="sm:col-span-2 flex items-start gap-3.5 p-3.5 rounded-xl bg-white/[0.07] border border-white/12">
                <div className="w-10 h-10 rounded-lg bg-white/15 text-white/90 flex items-center justify-center shrink-0 mt-0.5">
                  <MapPin className="w-5 h-5" />
                </div>
                <div className="min-w-0 flex-1">
                  <div className="text-[0.72rem] text-white/60 font-medium">Dapur Pusat & Kantor</div>
                  <div className="text-white/90 text-[0.85rem] font-medium leading-relaxed">
          ...
          <div className="lg:col-span-5 bg-white/[0.08] border border-white/15 rounded-3xl p-7 sm:p-9 backdrop-blur-md shadow-xl">
            ...
            <p className="text-white/80 text-[0.88rem] leading-[1.6] mb-6">
            ...
            <div className="text-center mt-5 text-[0.76rem] text-white/60">
              Layanan CS Aktif · <span className="text-white/90 font-medium">{company.contact.operatingHours}</span>
            </div>
          </div>
        </div>
      </Container>
